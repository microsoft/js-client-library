...
var DeployR = Base.extend(Emitter, RInputs, {
  ...
  */ 
   ...
   *
   * @method shell
   * @param {String|Object} filepath to define the fully qualified shell script 
   * for execution. 
